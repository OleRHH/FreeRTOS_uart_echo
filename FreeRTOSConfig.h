...
#define configUSE_TIME_SLICING                  1           // task with same prio toggle
#define configIDLE_SHOULD_YIELD                 0           // idle yields after beeing finished if other task with same prio exist(which runs the rest of the timeslice then)
...
#define configCPU_CLOCK_HZ                      16000000UL //120000000UL // 120MHz clock
